...
const SOURCEMAP_RENDERED = (
  <span>
    {' '}
    <b>{LABELS.renderedLength}</b>
    {' '}
    is a number of characters in the file after
    individual and
    <br />
    {' '}
...
const RENDRED = (
  <span>
    <b>{LABELS.renderedLength}</b>
    {' '}
    is a byte size of individual file after
    transformations and treeshake.
  </span>
)

const COMPRESSED = (
  <span>
    <b>{LABELS.gzipLength}</b>
    {' '}
    and
    <b>{LABELS.brotliLength}</b>
    {' '}
    is a byte size of individual file after
